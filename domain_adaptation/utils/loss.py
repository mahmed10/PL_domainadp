...
from domain_adaptation.utils import utils as rmi_utils
...
class RMILoss(nn.Module):
    ...
    def forward_softmax_sigmoid(self, logits_4D, labels_4D):
        ...
        #                                 reduction='mean')
        normal_loss = focal_loss(logits_4D,labels_4D.long())
