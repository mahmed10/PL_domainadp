...
def resnet50(pretrained=False, num_classes = 20, **kwargs):
...
def resnet101(pretrained=False, num_classes = 20, num_groups=None, weight_std=False, **kwargs):
    """Constructs a ResNet-101 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(Bottleneck, [3, 4, 23, 3], num_classes = num_classes, num_groups=num_groups, weight_std=weight_std, **kwargs)
    if pretrained:
